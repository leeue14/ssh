...
<form action="${pageContext.request.contextPath}/cart_addCart.action" method="get">
		...
		<div class="span6">
			<div class="hotProductCategory">
					...
					<s:iterator var="c" value="categoryList">
						<dl>
							<dt>
								<a href="${pageContext.request.contextPath}/product_findByCid.action?
								cid=<s:property value="#c.cid"/>&page=1"><s:property value="#c.cname"/></a>
							</dt>
								<!-- 二级分类显示 -->
								<s:iterator var="cs" value="#c.categorySeconds">
									<dd>
										<a href="${pageContext.request.contextPath}/product_findByCsid.action?
										csid=<s:property value="#cs.csid"/>&page=1"><s:property value="#cs.csname"/></a>
									</dd>
								</s:iterator>	
						</dl>
						</s:iterator>
		...
		<div class="span18 last">
			...
			<div class="productImage">
					<a title="" style="outline-style: none; text-decoration: none;" id="zoom" href="http://image/r___________renleipic_01/bigPic1ea8f1c9-8b8e-4262-8ca9-690912434692.jpg" rel="gallery">
						<div class="zoomPad">
							<img style="opacity: 1;" title="" class="medium" src="${pageContext.request.contextPath}/<s:property value="image"/>" />
			...
			<div class="name"><s:property value="pname"/></div>
			<div class="sn">
				<div>编号：<s:property value="pid"/></div>
			</div>
			<div class="info">
				<dl>
					<dt>商城价:</dt>
					<dd>
						<strong>￥：<s:property value="shop_price"/></strong>
							参 考 价：
						<del>￥:<s:property value="market_price"/></del>
					</dd>
				</dl>
					<dl>
						<dt>促销:</dt>
